...
- **Дерево БД** — иерархия подключений, баз, схем и таблиц с ленивой загрузкой
  ...
  всех таблиц БД, первая колонка — схема), клик по схеме — «Информация» и «Анализ».
...
| GET | `/api/connections/:id/databases/:db/analysis` | анализ всех таблиц БД (первая колонка — схема) |
